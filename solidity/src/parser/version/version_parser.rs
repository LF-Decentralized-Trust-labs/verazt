...
impl PragmaParser {
    ...
    fn parse_source_unit(pair: Pair<Rule>) -> Result<Vec<String>> {
    ...
    fn parse_pragma_solidity_version(pair: Pair<Rule>) -> Result<String> {
...
pub fn parse_pragma_solidity_version(source_code: &str) -> Result<Vec<String>> {
