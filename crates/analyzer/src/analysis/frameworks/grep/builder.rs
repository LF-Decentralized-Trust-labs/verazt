use crate::analysis::frameworks::grep::composite::{
    AndPattern, ContainsPattern, NotPattern, OrPattern, WherePattern,
};
use crate::analysis::frameworks::grep::core::{Match, Pattern};
use crate::analysis::frameworks::grep::primitives::{
...
impl Pattern for BinaryPattern {
    fn match_expr(
        ...
        ctx: &crate::analysis::frameworks::grep::core::MatchContext,
    ) -> Option<Match> {
    ...
    fn match_stmt(
        ...
        _ctx: &crate::analysis::frameworks::grep::core::MatchContext,
    ) -> Option<Match> {
        None
    }
