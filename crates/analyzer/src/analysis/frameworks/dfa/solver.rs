use crate::analysis::frameworks::dfa::annotated_cfg::{
    BasicBlock, BasicBlockId, ControlFlowGraph,
};
use crate::analysis::frameworks::dfa::lattice::Lattice;
use scirs::sir::Stmt;
...
mod tests {
    use super::*;
    use crate::analysis::frameworks::dfa::annotated_cfg::Terminator;
