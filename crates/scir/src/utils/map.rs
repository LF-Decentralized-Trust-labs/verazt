//! Map pattern for CIR — transforming traversal.
//!
//! Produces a new CIR tree with nodes potentially rewritten.

use crate::*;

/// Trait implementing the map design pattern for CIR.
/// Produces a new (potentially rewritten) CIR tree.
pub trait Map<'a> {
    // ── Module ──────────────────────────────────────
